...
try:
    from terrain.domains.upper.rag.client import create_llm_client, LLMClient
except ImportError:
...
def run_wiki_generation(
    ...
    from terrain.examples.generate_wiki import (
    ...
    from terrain.domains.upper.rag.camel_agent import CamelAgent
