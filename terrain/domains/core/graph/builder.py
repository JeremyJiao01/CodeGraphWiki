...
from terrain.foundation.types.config import ConfigValidator, EmbeddingConfig, KuzuConfig, MemgraphConfig, MemoryConfig, ScanConfig
...
from terrain.foundation.services.graph_service import MemgraphIngestor
from terrain.foundation.services.kuzu_service import KuzuIngestor
from terrain.foundation.types.types import BuildResult, GraphData, GraphSummary, PropertyDict, ResultRow
...
class TerrainBuilder:
    ...
    Examples:
        ...
        >>> from terrain.config import KuzuConfig, ScanConfig
        >>> builder = TerrainBuilder(
        ...     repo_path="/path/to/repo",
        ...     backend="kuzu",
    ...
    def __enter__(self) -> TerrainBuilder:
    ...
    def _get_embedder_and_store(self) -> tuple[Any | None, Any | None]:
        ...
        if self._embedder is None or self._vector_store is None:
            ...
            from terrain.domains.core.embedding.vector_store import create_vector_store
