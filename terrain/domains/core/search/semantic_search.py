...
from terrain.domains.core.embedding.vector_store import SearchResult, VectorStore

if TYPE_CHECKING:
    from terrain.foundation.services import IngestorProtocol, QueryProtocol
    from terrain.foundation.types.types import ResultRow
...
class SemanticSearchService:
    ...
    Example:
        ...
        >>> from terrain.services import MemgraphIngestor
