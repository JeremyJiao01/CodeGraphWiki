#!/usr/bin/env python3
"""Test terrain with Kùzu embedded database (no Docker)."""
...
def test_kuzu_backend():
    ...
    print("=" * 80)
    print("Testing terrain with Kùzu (No Docker)")
    print("=" * 80)
    ...
    print("Initializing TerrainBuilder with Kùzu backend...")
...
def test_memory_backend():
    ...
    print("\n" + "=" * 80)
    print("Testing terrain with Memory backend")
    print("=" * 80)

    # Initialize builder with memory backend
    print("Initializing TerrainBuilder with Memory backend...")
    builder = TerrainBuilder(
        repo_path=repo_path,
...
def main():
    """Run all tests."""
    print("Terrain - Local Deployment Test")
    ...
    print()
    print("You can now use terrain without Docker!")
    print()
    print("Usage:")
    print('  builder = TerrainBuilder(repo_path, backend="kuzu")')
    print('  builder = TerrainBuilder(repo_path, backend="memory")')
