...
Prerequisites:
    ...
    - Have a code graph built with terrain
...
from terrain.rag import (
    RAGConfig,
    RAGEngine,
    create_rag_engine,
)
from terrain.rag.camel_agent import CamelAgent, MultiAgentRAG
...
def example_explain_code(engine: RAGEngine) -> None:
    ...
    qualified_name = "terrain.rag.rag_engine.RAGEngine.query"
